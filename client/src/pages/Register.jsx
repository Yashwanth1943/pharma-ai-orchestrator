  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans text-slate-600">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden flex items-center justify-center">
        <div className="absolute w-[80vw] h-[80vw] max-w-[800px] max-h-[800px] rounded-full bg-indigo-400/20 mix-blend-multiply filter blur-[120px] animate-blob animation-delay-2000"></div>
        <div className="absolute w-[70vw] h-[70vw] max-w-[700px] max-h-[700px] rounded-full bg-purple-400/20 mix-blend-multiply filter blur-[120px] animate-blob ml-40 mt-20"></div>
        <div className="absolute w-[60vw] h-[60vw] max-w-[600px] max-h-[600px] rounded-full bg-blue-400/20 mix-blend-multiply filter blur-[100px] animate-blob animation-delay-4000 -ml-40 -mt-20"></div>
      ...
      <div className="relative z-10 mb-8 flex flex-col items-center">
        <Link to="/" className="group flex flex-col items-center gap-4">
          <div className="w-14 h-14 bg-white/80 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white shadow-lg shadow-indigo-900/5 group-hover:shadow-xl group-hover:shadow-indigo-900/10 transition-all duration-500">
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        <div className="bg-white/60 backdrop-blur-3xl border border-white p-8 sm:p-10 rounded-[2rem] shadow-2xl shadow-indigo-900/10">
          
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Create Account</h2>
            <p className="text-sm text-slate-500 mt-2 font-medium">Join the intelligent supply chain network.</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1.5 ml-1 uppercase tracking-wide">Full Name</label>
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full bg-white/80 border border-slate-200 rounded-xl py-3 pl-10 pr-4 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 focus:bg-white transition-all shadow-sm"
                />
              </div>
            </div>
        ...
        <p className="text-center mt-8 text-sm text-slate-500 font-medium">
          ...
          <Link to="/login" className="text-slate-900 hover:text-indigo-600 font-bold transition-colors ml-1">
            Sign in
          </Link>
        </p>
      </div>
